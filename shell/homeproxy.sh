...
# 平台基础URL
declare -A PLATFORMS=(
  ["x86_64"]="https://mirrors.sjtug.sjtu.edu.cn/immortalwrt/releases/24.10.4/packages/x86_64"
  ["aarch64_generic"]="https://mirrors.sjtug.sjtu.edu.cn/immortalwrt/releases/24.10.4/packages/aarch64_generic"
  ["aarch64_cortex-a53"]="https://mirrors.sjtug.sjtu.edu.cn/immortalwrt/releases/24.10.4/packages/aarch64_cortex-a53"
)
